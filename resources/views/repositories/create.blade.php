      ...
      <form action="{{ route('repositories.store') }}" method="POST">
        ...
        <div class="col-md-9 repo-create-left">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control autosize" rows="1" id="repo-description" name="description" placeholder="选填知识清单的描述"></textarea>
          </div>
          ...
          <div class="form-group">
            ...
            <div>
              <button class="btn btn-success btn-sm" type="button" id="btn_repo_edit">打开编辑器</button>&emsp;<span class="help-block small-p" style="display: inline !important;vertical-align:bottom;">支持 Markdown 语法。</span>
            </div>
            <br />
            <textarea class="form-control" id="repo_content" name="content" rows="10" placeholder="输入知识清单的正文内容"></textarea>
          </div>
