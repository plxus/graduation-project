    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <ul class="nav nav-tabs" role="tablist">
          ...
          {{-- 激活 --}}
          <li role="presentation" class="active"><a href="#followings" aria-controls="followings" role="tab" data-toggle="tab">&emsp;关注的用户 <span class="badge">{{ $user->followings->count() }}</span>&emsp;</a></li>
